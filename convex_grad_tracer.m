function convex_grad_tracer()
% convex_grad_tracer.m is a toy wrapper to illustrate the path
...
% dials for toy
alpha = 0.5;  % step length/learning rate (for gradient descent).  Preset to alpha = 1/2.6
